...
kkmservice.cgi: ${OBJECTFILES}
	${LINK.cc} -o kkmservice.cgi ${OBJECTFILES} ${LDLIBSOPTIONS} ./lib/x86_64/libfptr.so -luuid

${OBJECTDIR}/src/cgi.o: src/cgi.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cgi.o src/cgi.cpp

${OBJECTDIR}/src/datastrings.o: src/datastrings.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/datastrings.o src/datastrings.cpp

${OBJECTDIR}/src/json.o: src/json.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/json.o src/json.cpp

${OBJECTDIR}/src/kkm.o: src/kkm.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/kkm.o src/kkm.cpp

${OBJECTDIR}/src/kkm_functions.o: src/kkm_functions.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/kkm_functions.o src/kkm_functions.cpp
