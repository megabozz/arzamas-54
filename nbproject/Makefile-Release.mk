...
kkmservice.cgi: ${OBJECTFILES}
	${LINK.cc} -o kkmservice.cgi ${OBJECTFILES} ${LDLIBSOPTIONS} lib/linux/armhf/libfptr.so -luuid -s
...
${OBJECTDIR}/src/token.o: src/token.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/token.o src/token.cpp
